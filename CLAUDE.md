...
### Поверхность «Мир» (правый инспектор редактора)
Шапка: «Мир» + статус «Прочитать» + переключатель «эта глава / весь проект».
4 кнопки-загадки (Библия/Справочник/Ревизия/Синхронизация) сводятся в **одну «Мир»(N)**:
Справочник→scope-переключатель, Ревизия(trace/арка)→в карточку сущности, Синхронизация→
статус-строка. План внедрения и статус — в `REORG_PLAN.md`.
