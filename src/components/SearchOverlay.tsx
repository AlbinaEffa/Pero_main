    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-24 bg-[#1e2d1f]/20 backdrop-blur-sm">
      ...
      >
                  ...
                  <div className="space-y-1">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-xs text-[#1e2d1f]/60">
        ...
        {showReplace && textMatches.length > 0 && (
          <div className="p-3 border-t border-[#1e2d1f]/10 bg-[#f5f0e8]/50 text-xs text-[#1e2d1f]/60 flex items-center justify-center gap-4">
