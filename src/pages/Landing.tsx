...
export default function Landing() {
  return (
    <div className="min-h-screen bg-[var(--color-paper)] text-[var(--color-ink)] flex flex-col font-sans">
      {/* Header */}
      <header className="flex items-center justify-between p-6 lg:px-12 border-b border-ink/10">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
          ...
          <Link to="/login" className="bg-ink text-white px-5 py-2.5 rounded-full hover:bg-ink/80 transition-colors">
            Начать писать
          </Link>
        </nav>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 py-24 lg:py-32">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-ink/10 bg-white/50 text-xs font-semibold uppercase tracking-widest mb-8">
        ...
        <p className="text-lg md:text-xl text-ink/60 max-w-2xl mb-12 font-medium">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <Link to="/login" className="flex items-center gap-2 bg-ink text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-ink/80 transition-transform hover:scale-105">
            Начать писать бесплатно
            <MoveRight size={20} />
          </Link>
          <a href="#features" className="flex items-center gap-2 px-8 py-4 rounded-full text-lg font-medium border border-ink/20 hover:bg-ink/5 transition-colors">
            Изучить возможности
          </a>
        </div>
        ...
        <div id="features" className="grid md:grid-cols-3 gap-8 mt-32 max-w-6xl w-full text-left">
          <div className="p-8 rounded-3xl bg-white border border-ink/5 shadow-sm">
            ...
            <p className="text-ink/60 leading-relaxed">Следите за персонажами, локациями и лором в специальной базе данных с поиском прямо рядом с вашей рукописью.</p>
          </div>
          <div className="p-8 rounded-3xl bg-white border border-ink/5 shadow-sm">
            <div className="w-12 h-12 bg-[var(--color-paper-dark)] rounded-2xl flex items-center justify-center mb-6">
            ...
            <p className="text-ink/60 leading-relaxed">Скройте интерфейс и погрузитесь в историю. Только вы, чистый лист и ваше воображение.</p>
          </div>
          <div className="p-8 rounded-3xl bg-white border border-ink/5 shadow-sm">
            <div className="w-12 h-12 bg-[var(--color-paper-dark)] rounded-2xl flex items-center justify-center mb-6">
            ...
            <p className="text-ink/60 leading-relaxed">Перетаскивайте главы, устанавливайте цели по количеству слов и легко отслеживайте свой ежедневный прогресс.</p>
          </div>
        </div>
      </main>
